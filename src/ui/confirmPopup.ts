...
<section style="display: flex; flex-direction: column; position: relative; width: 100%; border-radius: 0.375rem; background: rgb(255, 255, 255); margin-top: 4rem; margin-bottom: 4rem; z-index: 1400; box-shadow: rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.05) 0px 4px 6px -2px; max-width: 12rem;">
    ...
    <div>
      <div style="padding-inline-start: 1rem;padding-inline-end: 1rem;padding-top: 1.25rem;padding-bottom: 1.25rem;">
        <div style="display: flex;flex-direction: column;" class="wallet-provider-list">
          ...
          <button class="confirm-button" style="margin-top: 10px; margin-bottom: 2epx; background: rgb(255, 255, 255); cursor: pointer; box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 3px 0px, rgba(0, 0, 0, 0.16) 0px 1px 2px 0px; border-radius: 0.25rem;">
            <div style="display: flex;justify-content:center;-webkit-box-align: center;align-items: center;padding: 0.75rem;">
              <b>Confirm</b>
            </div>
          </button>
          <button class="reject-button"style="margin-top: 10px; margin-bottom: 10px; background: rgb(255, 255, 255); cursor: pointer; box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 3px 0px, rgba(0, 0, 0, 0.16) 0px 1px 2px 0px; border-radius: 0.25rem;">
            <div style="display: flex;justify-content:center;-webkit-box-align: center;align-items: center;padding: 0.75rem;">
              <b>Reject</b>
            </div>
          </button>
